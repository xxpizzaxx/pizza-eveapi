...
trait Tables {
  ...
  lazy val schema = Array(Agtagents.schema,
                          Agtagenttypes.schema,
                          Agtresearchagents.schema,
                          Certcerts.schema,
                          Certmasteries.schema,
                          Certskills.schema,
                          Chrancestries.schema,
                          Chrattributes.schema,
                          Chrbloodlines.schema,
                          Chrfactions.schema,
                          Chrraces.schema,
                          Crpactivities.schema,
                          Crpnpccorporationdivisions.schema,
                          Crpnpccorporationresearchfields.schema,
                          Crpnpccorporations.schema,
                          Crpnpccorporationtrades.schema,
                          Crpnpcdivisions.schema,
                          Dgmattributecategories.schema,
                          Dgmattributetypes.schema,
                          Dgmeffects.schema,
                          Dgmexpressions.schema,
                          Dgmtypeattributes.schema,
                          Dgmtypeeffects.schema,
                          Evegraphics.schema,
                          Eveicons.schema,
                          Eveunits.schema,
                          Industryactivity.schema,
                          Industryactivitymaterials.schema,
                          Industryactivityprobabilities.schema,
                          Industryactivityproducts.schema,
                          Industryactivityskills.schema,
                          Industryblueprints.schema,
                          Invcategories.schema,
                          Invcontrabandtypes.schema,
                          Invcontroltowerresourcepurposes.schema,
                          Invcontroltowerresources.schema,
                          Invflags.schema,
                          Invgroups.schema,
                          Invitems.schema,
                          Invmarketgroups.schema,
                          Invmetagroups.schema,
                          Invmetatypes.schema,
                          Invnames.schema,
                          Invpositions.schema,
                          Invtraits.schema,
                          Invtypematerials.schema,
                          Invtypereactions.schema,
                          Invtypes.schema,
                          Invuniquenames.schema,
                          Mapcelestialstatistics.schema,
                          Mapconstellationjumps.schema,
                          Mapconstellations.schema,
                          Mapdenormalize.schema,
                          Mapjumps.schema,
                          Maplandmarks.schema,
                          Maplocationscenes.schema,
                          Maplocationwormholeclasses.schema,
                          Mapregionjumps.schema,
                          Mapregions.schema,
                          Mapsolarsystemjumps.schema,
                          Mapsolarsystems.schema,
                          Mapuniverse.schema,
                          Planetschematics.schema,
                          Planetschematicspinmap.schema,
                          Planetschematicstypemap.schema,
                          Ramactivities.schema,
                          Ramassemblylinestations.schema,
                          Ramassemblylinetypedetailpercategory.schema,
                          Ramassemblylinetypedetailpergroup.schema,
                          Ramassemblylinetypes.schema,
                          Raminstallationtypecontents.schema,
                          Skinlicense.schema,
                          Skinmaterials.schema,
                          Skins.schema,
                          Skinship.schema,
                          Staoperations.schema,
                          Staoperationservices.schema,
                          Staservices.schema,
                          Stastations.schema,
                          Stastationtypes.schema,
                          Translationtables.schema,
                          Trntranslationcolumns.schema,
                          Trntranslationlanguages.schema,
                          Trntranslations.schema,
                          Warcombatzones.schema,
                          Warcombatzonesystems.schema).reduceLeft(_ ++ _)
  ...
  case class AgtagentsRow(agentid: Int,
                          divisionid: Option[Byte] = None,
                          corporationid: Option[Int] = None,
                          locationid: Option[Int] = None,
                          level: Option[Byte] = None,
                          quality: Option[Short] = None,
                          agenttypeid: Option[Int] = None,
                          islocator: Option[Boolean] = None)

  /** GetResult implicit for fetching AgtagentsRow objects using plain SQL queries */
  implicit def GetResultAgtagentsRow(implicit e0: GR[Int],
                                     e1: GR[Option[Byte]],
                                     e2: GR[Option[Int]],
                                     e3: GR[Option[Short]],
                                     e4: GR[Option[Boolean]]): GR[AgtagentsRow] = GR { prs =>
    import prs._
  ...
  class Agtagents(_tableTag: Tag) extends Table[AgtagentsRow](_tableTag, "agtAgents") {
    def * =
      (agentid, divisionid, corporationid, locationid, level, quality, agenttypeid, islocator) <> (AgtagentsRow.tupled, AgtagentsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(agentid), divisionid, corporationid, locationid, level, quality, agenttypeid, islocator).shaped.<>({
        r =>
          import r._; _1.map(_ => AgtagentsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8)))
  ...
  class Agtagenttypes(_tableTag: Tag) extends Table[AgtagenttypesRow](_tableTag, "agtAgentTypes") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(agenttypeid), agenttype).shaped.<>({ r =>
        import r._; _1.map(_ => AgtagenttypesRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val agenttype: Rep[Option[String]] =
      column[Option[String]]("agentType", O.Length(50, varying = true), O.Default(None))
  }
  ...
  implicit def GetResultAgtresearchagentsRow(implicit e0: GR[Int]): GR[AgtresearchagentsRow] = GR { prs =>
    import prs._
  ...
  class Agtresearchagents(_tableTag: Tag) extends Table[AgtresearchagentsRow](_tableTag, "agtResearchAgents") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(agentid), Rep.Some(typeid)).shaped.<>({ r =>
        import r._; _1.map(_ => AgtresearchagentsRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class CertcertsRow(certid: Int,
                          description: Option[String] = None,
                          groupid: Option[Int] = None,
                          name: Option[String] = None)

  /** GetResult implicit for fetching CertcertsRow objects using plain SQL queries */
  implicit def GetResultCertcertsRow(implicit e0: GR[Int],
                                     e1: GR[Option[String]],
                                     e2: GR[Option[Int]]): GR[CertcertsRow] = GR { prs =>
    import prs._
  ...
  class Certcerts(_tableTag: Tag) extends Table[CertcertsRow](_tableTag, "certCerts") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(certid), description, groupid, name).shaped.<>({ r =>
        import r._; _1.map(_ => CertcertsRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Length(2147483647, varying = true), O.Default(None))
  ...
  implicit def GetResultCertmasteriesRow(implicit e0: GR[Option[Int]]): GR[CertmasteriesRow] = GR { prs =>
    import prs._
  ...
  case class CertskillsRow(certid: Option[Int] = None,
                           skillid: Option[Int] = None,
                           certlevelint: Option[Int] = None,
                           skilllevel: Option[Int] = None,
                           certleveltext: Option[String] = None)
  ...
  class Certskills(_tableTag: Tag) extends Table[CertskillsRow](_tableTag, "certSkills") {
    ...
    val certleveltext: Rep[Option[String]] =
      column[Option[String]]("certLevelText", O.Length(8, varying = true), O.Default(None))
  ...
  case class ChrancestriesRow(ancestryid: Byte,
                              ancestryname: Option[String] = None,
                              bloodlineid: Option[Byte] = None,
                              description: Option[String] = None,
                              perception: Option[Byte] = None,
                              willpower: Option[Byte] = None,
                              charisma: Option[Byte] = None,
                              memory: Option[Byte] = None,
                              intelligence: Option[Byte] = None,
                              iconid: Option[Int] = None,
                              shortdescription: Option[String] = None)

  /** GetResult implicit for fetching ChrancestriesRow objects using plain SQL queries */
  implicit def GetResultChrancestriesRow(implicit e0: GR[Byte],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Byte]],
                                         e3: GR[Option[Int]]): GR[ChrancestriesRow] = GR { prs =>
    import prs._
    ChrancestriesRow.tupled(
      (<<[Byte],
       <<?[String],
       <<?[Byte],
       <<?[String],
  ...
  class Chrancestries(_tableTag: Tag) extends Table[ChrancestriesRow](_tableTag, "chrAncestries") {
    def * =
      (ancestryid,
       ...
       intelligence,
       iconid,
       shortdescription) <> (ChrancestriesRow.tupled, ChrancestriesRow.unapply)
    ...
    def ? =
      (Rep.Some(ancestryid),
       ...
       intelligence,
       iconid,
       shortdescription).shaped.<>({ r =>
        import r._; _1.map(_ => ChrancestriesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val ancestryname: Rep[Option[String]] =
      column[Option[String]]("ancestryName", O.Length(100, varying = true), O.Default(None))
    ...
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Length(1000, varying = true), O.Default(None))
    ...
    val shortdescription: Rep[Option[String]] =
      column[Option[String]]("shortDescription", O.Length(500, varying = true), O.Default(None))
  }
  ...
  case class ChrattributesRow(attributeid: Byte,
  ...
  implicit def GetResultChrattributesRow(implicit e0: GR[Byte],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Int]]): GR[ChrattributesRow] = GR { prs =>
    import prs._
  ...
  class Chrattributes(_tableTag: Tag) extends Table[ChrattributesRow](_tableTag, "chrAttributes") {
    def * =
      (attributeid, attributename, description, iconid, shortdescription, notes) <> (ChrattributesRow.tupled, ChrattributesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(attributeid), attributename, description, iconid, shortdescription, notes).shaped.<>({ r =>
        import r._; _1.map(_ => ChrattributesRow.tupled((_1.get, _2, _3, _4, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val attributename: Rep[Option[String]] =
      column[Option[String]]("attributeName", O.Length(100, varying = true), O.Default(None))
  ...
  case class ChrbloodlinesRow(bloodlineid: Byte,
                              bloodlinename: Option[String] = None,
                              raceid: Option[Byte] = None,
                              description: Option[String] = None,
                              maledescription: Option[String] = None,
                              femaledescription: Option[String] = None,
                              shiptypeid: Option[Int] = None,
                              corporationid: Option[Int] = None,
                              perception: Option[Byte] = None,
                              willpower: Option[Byte] = None,
                              charisma: Option[Byte] = None,
                              ...
                              iconid: Option[Int] = None,
                              shortdescription: Option[String] = None,
                              shortmaledescription: Option[String] = None,
                              shortfemaledescription: Option[String] = None)

  /** GetResult implicit for fetching ChrbloodlinesRow objects using plain SQL queries */
  implicit def GetResultChrbloodlinesRow(implicit e0: GR[Byte],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Byte]],
                                         e3: GR[Option[Int]]): GR[ChrbloodlinesRow] = GR { prs =>
    import prs._
    ChrbloodlinesRow.tupled(
      (<<[Byte],
       <<?[String],
       <<?[Byte],
       <<?[String],
  ...
  class Chrbloodlines(_tableTag: Tag) extends Table[ChrbloodlinesRow](_tableTag, "chrBloodlines") {
    def * =
      (bloodlineid,
       ...
       shortfemaledescription) <> (ChrbloodlinesRow.tupled, ChrbloodlinesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(bloodlineid),
       bloodlinename,
       raceid,
       description,
       maledescription,
       ...
       shortdescription,
       shortmaledescription,
       shortfemaledescription).shaped.<>({ r =>
        import r._;
        _1.map(_ =>
          ChrbloodlinesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val bloodlinename: Rep[Option[String]] =
      column[Option[String]]("bloodlineName", O.Length(100, varying = true), O.Default(None))
    ...
    val maledescription: Rep[Option[String]] =
      column[Option[String]]("maleDescription", O.Length(1000, varying = true), O.Default(None))

    /** Database column femaleDescription SqlType(VARCHAR), Length(1000,true), Default(None) */
    val femaledescription: Rep[Option[String]] =
      column[Option[String]]("femaleDescription", O.Length(1000, varying = true), O.Default(None))
    ...
    val shortmaledescription: Rep[Option[String]] =
      column[Option[String]]("shortMaleDescription", O.Length(500, varying = true), O.Default(None))

    /** Database column shortFemaleDescription SqlType(VARCHAR), Length(500,true), Default(None) */
    val shortfemaledescription: Rep[Option[String]] =
      column[Option[String]]("shortFemaleDescription", O.Length(500, varying = true), O.Default(None))
  }
  ...
  /** Entity class storing rows of table Chrfactions
    ...
    *  @param iconid Database column iconID SqlType(INT), Default(None) */
  case class ChrfactionsRow(factionid: Int,
                            factionname: Option[String] = None,
                            description: Option[String] = None,
                            raceids: Option[Int] = None,
                            solarsystemid: Option[Int] = None,
                            corporationid: Option[Int] = None,
                            sizefactor: Option[Double] = None,
                            stationcount: Option[Short] = None,
                            stationsystemcount: Option[Short] = None,
                            militiacorporationid: Option[Int] = None,
                            iconid: Option[Int] = None)

  /** GetResult implicit for fetching ChrfactionsRow objects using plain SQL queries */
  implicit def GetResultChrfactionsRow(implicit e0: GR[Int],
                                       e1: GR[Option[String]],
                                       e2: GR[Option[Int]],
                                       e3: GR[Option[Double]],
                                       e4: GR[Option[Short]]): GR[ChrfactionsRow] = GR { prs =>
    import prs._
    ChrfactionsRow.tupled(
      (<<[Int],
       <<?[String],
       <<?[String],
       <<?[Int],
  ...
  class Chrfactions(_tableTag: Tag) extends Table[ChrfactionsRow](_tableTag, "chrFactions") {
    def * =
      (factionid,
       ...
       iconid) <> (ChrfactionsRow.tupled, ChrfactionsRow.unapply)
    ...
    def ? =
      (Rep.Some(factionid),
       ...
       militiacorporationid,
       iconid).shaped.<>({ r =>
        import r._; _1.map(_ => ChrfactionsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val factionname: Rep[Option[String]] =
      column[Option[String]]("factionName", O.Length(100, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Chrraces
    ...
    *  @param iconid Database column iconID SqlType(INT), Default(None)
    *  @param shortdescription Database column shortDescription SqlType(VARCHAR), Length(500,true), Default(None) */
  case class ChrracesRow(raceid: Byte,
                         racename: Option[String] = None,
                         description: Option[String] = None,
                         iconid: Option[Int] = None,
                         shortdescription: Option[String] = None)

  /** GetResult implicit for fetching ChrracesRow objects using plain SQL queries */
  implicit def GetResultChrracesRow(implicit e0: GR[Byte],
                                    e1: GR[Option[String]],
                                    e2: GR[Option[Int]]): GR[ChrracesRow] = GR { prs =>
    import prs._
  ...
  class Chrraces(_tableTag: Tag) extends Table[ChrracesRow](_tableTag, "chrRaces") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(raceid), racename, description, iconid, shortdescription).shaped.<>({ r =>
        import r._; _1.map(_ => ChrracesRow.tupled((_1.get, _2, _3, _4, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val racename: Rep[Option[String]] =
      column[Option[String]]("raceName", O.Length(100, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Crpactivities
    ...
    *  @param description Database column description SqlType(VARCHAR), Length(1000,true), Default(None) */
  case class CrpactivitiesRow(activityid: Byte,
  ...
  class Crpactivities(_tableTag: Tag) extends Table[CrpactivitiesRow](_tableTag, "crpActivities") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(activityid), activityname, description).shaped.<>({ r =>
        import r._; _1.map(_ => CrpactivitiesRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val activityname: Rep[Option[String]] =
      column[Option[String]]("activityName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultCrpnpccorporationdivisionsRow(implicit e0: GR[Int],
                                                      e1: GR[Byte],
                                                      e2: GR[Option[Byte]]): GR[CrpnpccorporationdivisionsRow] = GR {
    prs =>
      import prs._
  ...
  class Crpnpccorporationdivisions(_tableTag: Tag)
      extends Table[CrpnpccorporationdivisionsRow](_tableTag, "crpNPCCorporationDivisions") {
    def * =
      (corporationid, divisionid, size) <> (CrpnpccorporationdivisionsRow.tupled, CrpnpccorporationdivisionsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(corporationid), Rep.Some(divisionid), size).shaped.<>({ r =>
        import r._; _1.map(_ => CrpnpccorporationdivisionsRow.tupled((_1.get, _2.get, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultCrpnpccorporationresearchfieldsRow(
      implicit e0: GR[Int]): GR[CrpnpccorporationresearchfieldsRow] = GR { prs =>
    import prs._
  ...
  class Crpnpccorporationresearchfields(_tableTag: Tag)
      extends Table[CrpnpccorporationresearchfieldsRow](_tableTag, "crpNPCCorporationResearchFields") {
    def * =
      (skillid, corporationid) <> (CrpnpccorporationresearchfieldsRow.tupled, CrpnpccorporationresearchfieldsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(skillid), Rep.Some(corporationid)).shaped.<>({ r =>
        import r._; _1.map(_ => CrpnpccorporationresearchfieldsRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  type CrpnpccorporationsRow = HCons[Int,
                                     HCons[Option[Char],
                                           HCons[Option[Char],
                                                 HCons[Option[Int],
                                                       HCons[Option[Int],
  ...
  def CrpnpccorporationsRow(corporationid: Int,
                            size: Option[Char] = None,
                            extent: Option[Char] = None,
                            solarsystemid: Option[Int] = None,
                            investorid1: Option[Int] = None,
                            investorshares1: Option[Byte] = None,
                            investorid2: Option[Int] = None,
                            investorshares2: Option[Byte] = None,
                            investorid3: Option[Int] = None,
                            investorshares3: Option[Byte] = None,
                            investorid4: Option[Int] = None,
                            investorshares4: Option[Byte] = None,
                            friendid: Option[Int] = None,
                            enemyid: Option[Int] = None,
                            publicshares: Option[Long] = None,
                            initialprice: Option[Int] = None,
                            minsecurity: Option[Double] = None,
                            scattered: Option[Boolean] = None,
                            fringe: Option[Byte] = None,
                            corridor: Option[Byte] = None,
                            hub: Option[Byte] = None,
                            border: Option[Byte] = None,
                            factionid: Option[Int] = None,
                            sizefactor: Option[Double] = None,
                            stationcount: Option[Short] = None,
                            stationsystemcount: Option[Short] = None,
                            description: Option[String] = None,
                            iconid: Option[Int] = None): CrpnpccorporationsRow = {
  ...
  implicit def GetResultCrpnpccorporationsRow(implicit e0: GR[Int],
                                              e1: GR[Option[Char]],
                                              e2: GR[Option[Int]],
                                              e3: GR[Option[Byte]],
                                              e4: GR[Option[Long]],
                                              ...
                                              e7: GR[Option[Short]],
                                              e8: GR[Option[String]]): GR[CrpnpccorporationsRow] = GR { prs =>
    import prs._
    <<[Int] :: <<?[Char] :: <<?[Char] :: <<?[Int] :: <<?[Int] :: <<?[Byte] :: <<?[Int] :: <<?[Byte] :: <<?[Int] :: <<?[
      Byte] :: <<?[Int] :: <<?[Byte] :: <<?[Int] :: <<?[Int] :: <<?[Long] :: <<?[Int] :: <<?[Double] :: <<?[Boolean] :: <<?[
      Byte] :: <<?[Byte] :: <<?[Byte] :: <<?[Byte] :: <<?[Int] :: <<?[Double] :: <<?[Short] :: <<?[Short] :: <<?[
      String] :: <<?[Int] :: HNil
  }
  ...
  class Crpnpccorporations(_tableTag: Tag) extends Table[CrpnpccorporationsRow](_tableTag, "crpNPCCorporations") {
    ...
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Length(4000, varying = true), O.Default(None))
  ...
  implicit def GetResultCrpnpccorporationtradesRow(implicit e0: GR[Int]): GR[CrpnpccorporationtradesRow] = GR { prs =>
    import prs._
  ...
  class Crpnpccorporationtrades(_tableTag: Tag)
      extends Table[CrpnpccorporationtradesRow](_tableTag, "crpNPCCorporationTrades") {
    def * = (corporationid, typeid) <> (CrpnpccorporationtradesRow.tupled, CrpnpccorporationtradesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(corporationid), Rep.Some(typeid)).shaped.<>({ r =>
        import r._; _1.map(_ => CrpnpccorporationtradesRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class CrpnpcdivisionsRow(divisionid: Byte,
                                divisionname: Option[String] = None,
                                description: Option[String] = None,
                                leadertype: Option[String] = None)

  /** GetResult implicit for fetching CrpnpcdivisionsRow objects using plain SQL queries */
  implicit def GetResultCrpnpcdivisionsRow(implicit e0: GR[Byte], e1: GR[Option[String]]): GR[CrpnpcdivisionsRow] =
    GR { prs =>
      import prs._
  ...
  class Crpnpcdivisions(_tableTag: Tag) extends Table[CrpnpcdivisionsRow](_tableTag, "crpNPCDivisions") {
    def * =
      (divisionid, divisionname, description, leadertype) <> (CrpnpcdivisionsRow.tupled, CrpnpcdivisionsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(divisionid), divisionname, description, leadertype).shaped.<>({ r =>
        import r._; _1.map(_ => CrpnpcdivisionsRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val divisionname: Rep[Option[String]] =
      column[Option[String]]("divisionName", O.Length(100, varying = true), O.Default(None))
    ...
    val leadertype: Rep[Option[String]] =
      column[Option[String]]("leaderType", O.Length(100, varying = true), O.Default(None))
  }
  ...
  case class DgmattributecategoriesRow(categoryid: Byte,
                                       categoryname: Option[String] = None,
                                       categorydescription: Option[String] = None)

  /** GetResult implicit for fetching DgmattributecategoriesRow objects using plain SQL queries */
  implicit def GetResultDgmattributecategoriesRow(implicit e0: GR[Byte],
                                                  e1: GR[Option[String]]): GR[DgmattributecategoriesRow] = GR { prs =>
    import prs._
  ...
  class Dgmattributecategories(_tableTag: Tag)
      extends Table[DgmattributecategoriesRow](_tableTag, "dgmAttributeCategories") {
    def * =
      (categoryid, categoryname, categorydescription) <> (DgmattributecategoriesRow.tupled, DgmattributecategoriesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(categoryid), categoryname, categorydescription).shaped.<>({ r =>
        import r._; _1.map(_ => DgmattributecategoriesRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val categoryname: Rep[Option[String]] =
      column[Option[String]]("categoryName", O.Length(50, varying = true), O.Default(None))

    /** Database column categoryDescription SqlType(VARCHAR), Length(200,true), Default(None) */
    val categorydescription: Rep[Option[String]] =
      column[Option[String]]("categoryDescription", O.Length(200, varying = true), O.Default(None))
  }
  ...
  case class DgmattributetypesRow(attributeid: Short,
                                  attributename: Option[String] = None,
                                  description: Option[String] = None,
                                  iconid: Option[Int] = None,
                                  ...
                                  unitid: Option[Byte] = None,
                                  stackable: Option[Boolean] = None,
                                  highisgood: Option[Boolean] = None,
                                  categoryid: Option[Byte] = None)

  /** GetResult implicit for fetching DgmattributetypesRow objects using plain SQL queries */
  implicit def GetResultDgmattributetypesRow(implicit e0: GR[Short],
                                             e1: GR[Option[String]],
                                             e2: GR[Option[Int]],
                                             e3: GR[Option[Double]],
                                             e4: GR[Option[Boolean]],
                                             e5: GR[Option[Byte]]): GR[DgmattributetypesRow] = GR { prs =>
    import prs._
    DgmattributetypesRow.tupled(
      (<<[Short],
       <<?[String],
       <<?[String],
       <<?[Int],
  ...
  class Dgmattributetypes(_tableTag: Tag) extends Table[DgmattributetypesRow](_tableTag, "dgmAttributeTypes") {
    def * =
      (attributeid,
       ...
       stackable,
       highisgood,
       categoryid) <> (DgmattributetypesRow.tupled, DgmattributetypesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(attributeid),
       attributename,
       description,
       iconid,
       defaultvalue,
       ...
       highisgood,
       categoryid).shaped.<>({ r =>
        import r._; _1.map(_ => DgmattributetypesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val displayname: Rep[Option[String]] =
      column[Option[String]]("displayName", O.Length(100, varying = true), O.Default(None))
  ...
  type DgmeffectsRow = HCons[Short,
                             HCons[Option[String],
                                   HCons[Option[Short],
                                         HCons[Option[Int],
                                               HCons[Option[Int],
  ...
  def DgmeffectsRow(effectid: Short,
                    effectname: Option[String] = None,
                    effectcategory: Option[Short] = None,
                    preexpression: Option[Int] = None,
                    postexpression: Option[Int] = None,
                    description: Option[String] = None,
                    guid: Option[String] = None,
                    iconid: Option[Int] = None,
                    isoffensive: Option[Boolean] = None,
                    isassistance: Option[Boolean] = None,
                    durationattributeid: Option[Short] = None,
                    trackingspeedattributeid: Option[Short] = None,
                    dischargeattributeid: Option[Short] = None,
                    rangeattributeid: Option[Short] = None,
                    falloffattributeid: Option[Short] = None,
                    disallowautorepeat: Option[Boolean] = None,
                    published: Option[Boolean] = None,
                    displayname: Option[String] = None,
                    iswarpsafe: Option[Boolean] = None,
                    rangechance: Option[Boolean] = None,
                    electronicchance: Option[Boolean] = None,
                    propulsionchance: Option[Boolean] = None,
                    distribution: Option[Byte] = None,
                    sfxname: Option[String] = None,
                    npcusagechanceattributeid: Option[Short] = None,
                    npcactivationchanceattributeid: Option[Short] = None,
                    fittingusagechanceattributeid: Option[Short] = None,
                    modifierinfo: Option[String] = None): DgmeffectsRow = {
  ...
  implicit def GetResultDgmeffectsRow(implicit e0: GR[Short],
                                      e1: GR[Option[String]],
                                      e2: GR[Option[Short]],
                                      e3: GR[Option[Int]],
                                      e4: GR[Option[Boolean]],
                                      e5: GR[Option[Byte]]): GR[DgmeffectsRow] = GR { prs =>
    import prs._
    <<[Short] :: <<?[String] :: <<?[Short] :: <<?[Int] :: <<?[Int] :: <<?[String] :: <<?[String] :: <<?[Int] :: <<?[
      Boolean] :: <<?[Boolean] :: <<?[Short] :: <<?[Short] :: <<?[Short] :: <<?[Short] :: <<?[Short] :: <<?[Boolean] :: <<?[
      Boolean] :: <<?[String] :: <<?[Boolean] :: <<?[Boolean] :: <<?[Boolean] :: <<?[Boolean] :: <<?[Byte] :: <<?[
      String] :: <<?[Short] :: <<?[Short] :: <<?[Short] :: <<?[String] :: HNil
  }
  ...
  class Dgmeffects(_tableTag: Tag) extends Table[DgmeffectsRow](_tableTag, "dgmEffects") {
    ...
    val effectname: Rep[Option[String]] =
      column[Option[String]]("effectName", O.Length(400, varying = true), O.Default(None))
    ...
    val trackingspeedattributeid: Rep[Option[Short]] =
      column[Option[Short]]("trackingSpeedAttributeID", O.Default(None))
    ...
    val npcusagechanceattributeid: Rep[Option[Short]] =
      column[Option[Short]]("npcUsageChanceAttributeID", O.Default(None))

    /** Database column npcActivationChanceAttributeID SqlType(SMALLINT), Default(None) */
    val npcactivationchanceattributeid: Rep[Option[Short]] =
      column[Option[Short]]("npcActivationChanceAttributeID", O.Default(None))

    /** Database column fittingUsageChanceAttributeID SqlType(SMALLINT), Default(None) */
    val fittingusagechanceattributeid: Rep[Option[Short]] =
      column[Option[Short]]("fittingUsageChanceAttributeID", O.Default(None))

    /** Database column modifierInfo SqlType(LONGTEXT), Length(2147483647,true), Default(None) */
    val modifierinfo: Rep[Option[String]] =
      column[Option[String]]("modifierInfo", O.Length(2147483647, varying = true), O.Default(None))
  }
  ...
  case class DgmexpressionsRow(expressionid: Int,
                               operandid: Option[Int] = None,
                               arg1: Option[Int] = None,
                               arg2: Option[Int] = None,
                               expressionvalue: Option[String] = None,
                               description: Option[String] = None,
                               expressionname: Option[String] = None,
                               expressiontypeid: Option[Int] = None,
                               expressiongroupid: Option[Short] = None,
                               expressionattributeid: Option[Short] = None)

  /** GetResult implicit for fetching DgmexpressionsRow objects using plain SQL queries */
  implicit def GetResultDgmexpressionsRow(implicit e0: GR[Int],
                                          e1: GR[Option[Int]],
                                          e2: GR[Option[String]],
                                          e3: GR[Option[Short]]): GR[DgmexpressionsRow] = GR { prs =>
    import prs._
    DgmexpressionsRow.tupled(
      (<<[Int], <<?[Int], <<?[Int], <<?[Int], <<?[String], <<?[String], <<?[String], <<?[Int], <<?[Short], <<?[Short]))
  }
  ...
  class Dgmexpressions(_tableTag: Tag) extends Table[DgmexpressionsRow](_tableTag, "dgmExpressions") {
    def * =
      (expressionid,
       ...
       expressiontypeid,
       expressiongroupid,
       expressionattributeid) <> (DgmexpressionsRow.tupled, DgmexpressionsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(expressionid),
       operandid,
       arg1,
       arg2,
       expressionvalue,
       ...
       expressiontypeid,
       expressiongroupid,
       expressionattributeid).shaped.<>({ r =>
        import r._; _1.map(_ => DgmexpressionsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val expressionvalue: Rep[Option[String]] =
      column[Option[String]]("expressionValue", O.Length(100, varying = true), O.Default(None))
    ...
    val expressionname: Rep[Option[String]] =
      column[Option[String]]("expressionName", O.Length(500, varying = true), O.Default(None))
  ...
  case class DgmtypeattributesRow(typeid: Int,
                                  attributeid: Short,
                                  valueint: Option[Int] = None,
                                  valuefloat: Option[Double] = None)

  /** GetResult implicit for fetching DgmtypeattributesRow objects using plain SQL queries */
  implicit def GetResultDgmtypeattributesRow(implicit e0: GR[Int],
                                             e1: GR[Short],
                                             e2: GR[Option[Int]],
                                             e3: GR[Option[Double]]): GR[DgmtypeattributesRow] = GR { prs =>
    import prs._
  ...
  class Dgmtypeattributes(_tableTag: Tag) extends Table[DgmtypeattributesRow](_tableTag, "dgmTypeAttributes") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), Rep.Some(attributeid), valueint, valuefloat).shaped.<>({ r =>
        import r._; _1.map(_ => DgmtypeattributesRow.tupled((_1.get, _2.get, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultDgmtypeeffectsRow(implicit e0: GR[Int],
                                          e1: GR[Short],
                                          e2: GR[Option[Boolean]]): GR[DgmtypeeffectsRow] = GR { prs =>
    import prs._
  ...
  class Dgmtypeeffects(_tableTag: Tag) extends Table[DgmtypeeffectsRow](_tableTag, "dgmTypeEffects") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), Rep.Some(effectid), isdefault).shaped.<>({ r =>
        import r._; _1.map(_ => DgmtypeeffectsRow.tupled((_1.get, _2.get, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Evegraphics
    ...
    *  @param description Database column description SqlType(LONGTEXT), Length(2147483647,true), Default(None) */
  case class EvegraphicsRow(graphicid: Int,
                            soffactionname: Option[String] = None,
                            graphicfile: Option[String] = None,
                            sofhullname: Option[String] = None,
                            sofracename: Option[String] = None,
                            description: Option[String] = None)

  /** GetResult implicit for fetching EvegraphicsRow objects using plain SQL queries */
  implicit def GetResultEvegraphicsRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[EvegraphicsRow] = GR { prs =>
    import prs._
  ...
  class Evegraphics(_tableTag: Tag) extends Table[EvegraphicsRow](_tableTag, "eveGraphics") {
    def * =
      (graphicid, soffactionname, graphicfile, sofhullname, sofracename, description) <> (EvegraphicsRow.tupled, EvegraphicsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(graphicid), soffactionname, graphicfile, sofhullname, sofracename, description).shaped.<>({ r =>
        import r._; _1.map(_ => EvegraphicsRow.tupled((_1.get, _2, _3, _4, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val soffactionname: Rep[Option[String]] =
      column[Option[String]]("sofFactionName", O.Length(100, varying = true), O.Default(None))

    /** Database column graphicFile SqlType(VARCHAR), Length(100,true), Default(None) */
    val graphicfile: Rep[Option[String]] =
      column[Option[String]]("graphicFile", O.Length(100, varying = true), O.Default(None))

    /** Database column sofHullName SqlType(VARCHAR), Length(100,true), Default(None) */
    val sofhullname: Rep[Option[String]] =
      column[Option[String]]("sofHullName", O.Length(100, varying = true), O.Default(None))

    /** Database column sofRaceName SqlType(VARCHAR), Length(100,true), Default(None) */
    val sofracename: Rep[Option[String]] =
      column[Option[String]]("sofRaceName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultEveiconsRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[EveiconsRow] = GR { prs =>
    import prs._
  ...
  class Eveicons(_tableTag: Tag) extends Table[EveiconsRow](_tableTag, "eveIcons") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(iconid), iconfile, description).shaped.<>({ r =>
        import r._; _1.map(_ => EveiconsRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val iconfile: Rep[Option[String]] =
      column[Option[String]]("iconFile", O.Length(500, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Eveunits
    ...
    *  @param description Database column description SqlType(VARCHAR), Length(1000,true), Default(None) */
  case class EveunitsRow(unitid: Byte,
                         unitname: Option[String] = None,
                         displayname: Option[String] = None,
                         description: Option[String] = None)

  /** GetResult implicit for fetching EveunitsRow objects using plain SQL queries */
  implicit def GetResultEveunitsRow(implicit e0: GR[Byte], e1: GR[Option[String]]): GR[EveunitsRow] = GR { prs =>
    import prs._
  ...
  class Eveunits(_tableTag: Tag) extends Table[EveunitsRow](_tableTag, "eveUnits") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(unitid), unitname, displayname, description).shaped.<>({ r =>
        import r._; _1.map(_ => EveunitsRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val unitname: Rep[Option[String]] =
      column[Option[String]]("unitName", O.Length(100, varying = true), O.Default(None))

    /** Database column displayName SqlType(VARCHAR), Length(50,true), Default(None) */
    val displayname: Rep[Option[String]] =
      column[Option[String]]("displayName", O.Length(50, varying = true), O.Default(None))
  ...
  class Industryactivity(_tableTag: Tag) extends Table[IndustryactivityRow](_tableTag, "industryActivity") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), Rep.Some(activityid), time).shaped.<>({ r =>
        import r._; _1.map(_ => IndustryactivityRow.tupled((_1.get, _2.get, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class IndustryactivitymaterialsRow(typeid: Option[Int] = None,
                                          activityid: Option[Int] = None,
                                          materialtypeid: Option[Int] = None,
                                          quantity: Option[Int] = None)

  /** GetResult implicit for fetching IndustryactivitymaterialsRow objects using plain SQL queries */
  implicit def GetResultIndustryactivitymaterialsRow(implicit e0: GR[Option[Int]]): GR[IndustryactivitymaterialsRow] =
    GR { prs =>
      import prs._
  ...
  class Industryactivitymaterials(_tableTag: Tag)
      extends Table[IndustryactivitymaterialsRow](_tableTag, "industryActivityMaterials") {
    def * =
      (typeid, activityid, materialtypeid, quantity) <> (IndustryactivitymaterialsRow.tupled, IndustryactivitymaterialsRow.unapply)
  ...
  case class IndustryactivityprobabilitiesRow(typeid: Option[Int] = None,
                                              activityid: Option[Int] = None,
                                              producttypeid: Option[Int] = None,
                                              probability: Option[scala.math.BigDecimal] = None)

  /** GetResult implicit for fetching IndustryactivityprobabilitiesRow objects using plain SQL queries */
  implicit def GetResultIndustryactivityprobabilitiesRow(
      implicit e0: GR[Option[Int]],
      e1: GR[Option[scala.math.BigDecimal]]): GR[IndustryactivityprobabilitiesRow] = GR { prs =>
    import prs._
  ...
  class Industryactivityprobabilities(_tableTag: Tag)
      extends Table[IndustryactivityprobabilitiesRow](_tableTag, "industryActivityProbabilities") {
    def * =
      (typeid, activityid, producttypeid, probability) <> (IndustryactivityprobabilitiesRow.tupled, IndustryactivityprobabilitiesRow.unapply)
    ...
    val probability: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("probability", O.Default(None))
  ...
  /** Entity class storing rows of table Industryactivityproducts
    ...
    *  @param producttypeid Database column productTypeID SqlType(INT), Default(None)
    *  @param quantity Database column quantity SqlType(INT), Default(None) */
  case class IndustryactivityproductsRow(typeid: Option[Int] = None,
                                         activityid: Option[Int] = None,
                                         producttypeid: Option[Int] = None,
                                         quantity: Option[Int] = None)

  /** GetResult implicit for fetching IndustryactivityproductsRow objects using plain SQL queries */
  implicit def GetResultIndustryactivityproductsRow(implicit e0: GR[Option[Int]]): GR[IndustryactivityproductsRow] =
    GR { prs =>
      import prs._
  ...
  class Industryactivityproducts(_tableTag: Tag)
      extends Table[IndustryactivityproductsRow](_tableTag, "industryActivityProducts") {
    def * =
      (typeid, activityid, producttypeid, quantity) <> (IndustryactivityproductsRow.tupled, IndustryactivityproductsRow.unapply)
  ...
  case class IndustryactivityskillsRow(typeid: Option[Int] = None,
                                       activityid: Option[Int] = None,
                                       skillid: Option[Int] = None,
  ...
  class Industryactivityskills(_tableTag: Tag)
      extends Table[IndustryactivityskillsRow](_tableTag, "industryActivitySkills") {
    def * =
      (typeid, activityid, skillid, level) <> (IndustryactivityskillsRow.tupled, IndustryactivityskillsRow.unapply)
  ...
  implicit def GetResultIndustryblueprintsRow(implicit e0: GR[Int], e1: GR[Option[Int]]): GR[IndustryblueprintsRow] =
    GR { prs =>
      import prs._
  ...
  class Industryblueprints(_tableTag: Tag) extends Table[IndustryblueprintsRow](_tableTag, "industryBlueprints") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), maxproductionlimit).shaped.<>({ r =>
        import r._; _1.map(_ => IndustryblueprintsRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Invcategories
    ...
    *  @param published Database column published SqlType(BIT), Default(None) */
  case class InvcategoriesRow(categoryid: Int,
                              categoryname: Option[String] = None,
                              iconid: Option[Long] = None,
                              published: Option[Boolean] = None)

  /** GetResult implicit for fetching InvcategoriesRow objects using plain SQL queries */
  implicit def GetResultInvcategoriesRow(implicit e0: GR[Int],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Long]],
                                         e3: GR[Option[Boolean]]): GR[InvcategoriesRow] = GR { prs =>
    import prs._
  ...
  class Invcategories(_tableTag: Tag) extends Table[InvcategoriesRow](_tableTag, "invCategories") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(categoryid), categoryname, iconid, published).shaped.<>({ r =>
        import r._; _1.map(_ => InvcategoriesRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val categoryname: Rep[Option[String]] =
      column[Option[String]]("categoryName", O.Length(100, varying = true), O.Default(None))
  ...
  case class InvcontrabandtypesRow(factionid: Int,
                                   typeid: Int,
                                   standingloss: Option[Double] = None,
                                   confiscateminsec: Option[Double] = None,
                                   finebyvalue: Option[Double] = None,
                                   attackminsec: Option[Double] = None)

  /** GetResult implicit for fetching InvcontrabandtypesRow objects using plain SQL queries */
  implicit def GetResultInvcontrabandtypesRow(implicit e0: GR[Int],
                                              e1: GR[Option[Double]]): GR[InvcontrabandtypesRow] = GR { prs =>
    import prs._
  ...
  class Invcontrabandtypes(_tableTag: Tag) extends Table[InvcontrabandtypesRow](_tableTag, "invContrabandTypes") {
    def * =
      (factionid, typeid, standingloss, confiscateminsec, finebyvalue, attackminsec) <> (InvcontrabandtypesRow.tupled, InvcontrabandtypesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(factionid), Rep.Some(typeid), standingloss, confiscateminsec, finebyvalue, attackminsec).shaped.<>({
        r =>
          import r._; _1.map(_ => InvcontrabandtypesRow.tupled((_1.get, _2.get, _3, _4, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultInvcontroltowerresourcepurposesRow(
      implicit e0: GR[Byte],
      e1: GR[Option[String]]): GR[InvcontroltowerresourcepurposesRow] = GR { prs =>
    import prs._
  ...
  class Invcontroltowerresourcepurposes(_tableTag: Tag)
      extends Table[InvcontroltowerresourcepurposesRow](_tableTag, "invControlTowerResourcePurposes") {
    def * =
      (purpose, purposetext) <> (InvcontroltowerresourcepurposesRow.tupled, InvcontroltowerresourcepurposesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(purpose), purposetext).shaped.<>({ r =>
        import r._; _1.map(_ => InvcontroltowerresourcepurposesRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val purposetext: Rep[Option[String]] =
      column[Option[String]]("purposeText", O.Length(100, varying = true), O.Default(None))
  }
  ...
  case class InvcontroltowerresourcesRow(controltowertypeid: Int,
                                         resourcetypeid: Int,
                                         purpose: Option[Byte] = None,
                                         quantity: Option[Int] = None,
                                         minsecuritylevel: Option[Double] = None,
                                         factionid: Option[Int] = None)

  /** GetResult implicit for fetching InvcontroltowerresourcesRow objects using plain SQL queries */
  implicit def GetResultInvcontroltowerresourcesRow(implicit e0: GR[Int],
                                                    e1: GR[Option[Byte]],
                                                    e2: GR[Option[Int]],
                                                    e3: GR[Option[Double]]): GR[InvcontroltowerresourcesRow] = GR {
    prs =>
      import prs._
  ...
  class Invcontroltowerresources(_tableTag: Tag)
      extends Table[InvcontroltowerresourcesRow](_tableTag, "invControlTowerResources") {
    def * =
      (controltowertypeid, resourcetypeid, purpose, quantity, minsecuritylevel, factionid) <> (InvcontroltowerresourcesRow.tupled, InvcontroltowerresourcesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(controltowertypeid), Rep.Some(resourcetypeid), purpose, quantity, minsecuritylevel, factionid).shaped
        .<>({ r =>
          import r._; _1.map(_ => InvcontroltowerresourcesRow.tupled((_1.get, _2.get, _3, _4, _5, _6)))
        }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class InvflagsRow(flagid: Short,
                         flagname: Option[String] = None,
                         flagtext: Option[String] = None,
                         orderid: Option[Int] = None)

  /** GetResult implicit for fetching InvflagsRow objects using plain SQL queries */
  implicit def GetResultInvflagsRow(implicit e0: GR[Short],
                                    e1: GR[Option[String]],
                                    e2: GR[Option[Int]]): GR[InvflagsRow] = GR { prs =>
    import prs._
  ...
  class Invflags(_tableTag: Tag) extends Table[InvflagsRow](_tableTag, "invFlags") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(flagid), flagname, flagtext, orderid).shaped.<>({ r =>
        import r._; _1.map(_ => InvflagsRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val flagname: Rep[Option[String]] =
      column[Option[String]]("flagName", O.Length(200, varying = true), O.Default(None))

    /** Database column flagText SqlType(VARCHAR), Length(100,true), Default(None) */
    val flagtext: Rep[Option[String]] =
      column[Option[String]]("flagText", O.Length(100, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Invgroups
    ...
    *  @param published Database column published SqlType(BIT), Default(None) */
  case class InvgroupsRow(groupid: Int,
                          categoryid: Option[Int] = None,
                          groupname: Option[String] = None,
                          iconid: Option[Long] = None,
                          usebaseprice: Option[Boolean] = None,
                          anchored: Option[Boolean] = None,
                          anchorable: Option[Boolean] = None,
                          fittablenonsingleton: Option[Boolean] = None,
                          published: Option[Boolean] = None)

  /** GetResult implicit for fetching InvgroupsRow objects using plain SQL queries */
  implicit def GetResultInvgroupsRow(implicit e0: GR[Int],
                                     e1: GR[Option[Int]],
                                     e2: GR[Option[String]],
                                     e3: GR[Option[Long]],
                                     e4: GR[Option[Boolean]]): GR[InvgroupsRow] = GR { prs =>
    import prs._
    InvgroupsRow.tupled(
      (<<[Int],
       <<?[Int],
  ...
  class Invgroups(_tableTag: Tag) extends Table[InvgroupsRow](_tableTag, "invGroups") {
    def * =
      (groupid, categoryid, groupname, iconid, usebaseprice, anchored, anchorable, fittablenonsingleton, published) <> (InvgroupsRow.tupled, InvgroupsRow.unapply)
    ...
    def ? =
      (Rep.Some(groupid),
       ...
       published).shaped.<>({ r =>
        import r._; _1.map(_ => InvgroupsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val groupname: Rep[Option[String]] =
      column[Option[String]]("groupName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultInvitemsRow(implicit e0: GR[Long], e1: GR[Int], e2: GR[Short]): GR[InvitemsRow] = GR { prs =>
    import prs._
  ...
  class Invitems(_tableTag: Tag) extends Table[InvitemsRow](_tableTag, "invItems") {
    ...
    def ? =
      (Rep.Some(itemid),
       ...
       Rep.Some(locationid),
       Rep.Some(flagid),
       Rep.Some(quantity)).shaped.<>({ r =>
        import r._; _1.map(_ => InvitemsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class InvmarketgroupsRow(marketgroupid: Int,
                                parentgroupid: Option[Int] = None,
                                marketgroupname: Option[String] = None,
                                description: Option[String] = None,
                                iconid: Option[Int] = None,
                                hastypes: Option[Boolean] = None)

  /** GetResult implicit for fetching InvmarketgroupsRow objects using plain SQL queries */
  implicit def GetResultInvmarketgroupsRow(implicit e0: GR[Int],
                                           e1: GR[Option[Int]],
                                           e2: GR[Option[String]],
                                           e3: GR[Option[Boolean]]): GR[InvmarketgroupsRow] = GR { prs =>
    import prs._
  ...
  class Invmarketgroups(_tableTag: Tag) extends Table[InvmarketgroupsRow](_tableTag, "invMarketGroups") {
    def * =
      (marketgroupid, parentgroupid, marketgroupname, description, iconid, hastypes) <> (InvmarketgroupsRow.tupled, InvmarketgroupsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(marketgroupid), parentgroupid, marketgroupname, description, iconid, hastypes).shaped.<>({ r =>
        import r._; _1.map(_ => InvmarketgroupsRow.tupled((_1.get, _2, _3, _4, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val marketgroupname: Rep[Option[String]] =
      column[Option[String]]("marketGroupName", O.Length(100, varying = true), O.Default(None))

    /** Database column description SqlType(VARCHAR), Length(3000,true), Default(None) */
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Length(3000, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Invmetagroups
    ...
    *  @param description Database column description SqlType(VARCHAR), Length(1000,true), Default(None)
    *  @param iconid Database column iconID SqlType(INT), Default(None) */
  case class InvmetagroupsRow(metagroupid: Short,
                              metagroupname: Option[String] = None,
                              description: Option[String] = None,
                              iconid: Option[Int] = None)

  /** GetResult implicit for fetching InvmetagroupsRow objects using plain SQL queries */
  implicit def GetResultInvmetagroupsRow(implicit e0: GR[Short],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Int]]): GR[InvmetagroupsRow] = GR { prs =>
    import prs._
  ...
  class Invmetagroups(_tableTag: Tag) extends Table[InvmetagroupsRow](_tableTag, "invMetaGroups") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(metagroupid), metagroupname, description, iconid).shaped.<>({ r =>
        import r._; _1.map(_ => InvmetagroupsRow.tupled((_1.get, _2, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val metagroupname: Rep[Option[String]] =
      column[Option[String]]("metaGroupName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultInvmetatypesRow(implicit e0: GR[Int],
                                        e1: GR[Option[Int]],
                                        e2: GR[Option[Short]]): GR[InvmetatypesRow] = GR { prs =>
    import prs._
  ...
  class Invmetatypes(_tableTag: Tag) extends Table[InvmetatypesRow](_tableTag, "invMetaTypes") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), parenttypeid, metagroupid).shaped.<>({ r =>
        import r._; _1.map(_ => InvmetatypesRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultInvnamesRow(implicit e0: GR[Long], e1: GR[String]): GR[InvnamesRow] = GR { prs =>
    import prs._
  ...
  class Invnames(_tableTag: Tag) extends Table[InvnamesRow](_tableTag, "invNames") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(itemid), Rep.Some(itemname)).shaped.<>({ r =>
        import r._; _1.map(_ => InvnamesRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class InvpositionsRow(itemid: Long,
                             x: Double = 0.0,
                             y: Double = 0.0,
                             z: Double = 0.0,
                             yaw: Option[Float] = None,
                             pitch: Option[Float] = None,
                             roll: Option[Float] = None)

  /** GetResult implicit for fetching InvpositionsRow objects using plain SQL queries */
  implicit def GetResultInvpositionsRow(implicit e0: GR[Long],
                                        e1: GR[Double],
                                        e2: GR[Option[Float]]): GR[InvpositionsRow] = GR { prs =>
    import prs._
  ...
  class Invpositions(_tableTag: Tag) extends Table[InvpositionsRow](_tableTag, "invPositions") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(itemid), Rep.Some(x), Rep.Some(y), Rep.Some(z), yaw, pitch, roll).shaped.<>({ r =>
        import r._; _1.map(_ => InvpositionsRow.tupled((_1.get, _2.get, _3.get, _4.get, _5, _6, _7)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class InvtraitsRow(traitid: Int,
                          typeid: Option[Int] = None,
                          skillid: Option[Int] = None,
                          bonus: Option[Double] = None,
                          bonustext: Option[String] = None,
                          unitid: Option[Int] = None)

  /** GetResult implicit for fetching InvtraitsRow objects using plain SQL queries */
  implicit def GetResultInvtraitsRow(implicit e0: GR[Int],
                                     e1: GR[Option[Int]],
                                     e2: GR[Option[Double]],
                                     e3: GR[Option[String]]): GR[InvtraitsRow] = GR { prs =>
    import prs._
  ...
  class Invtraits(_tableTag: Tag) extends Table[InvtraitsRow](_tableTag, "invTraits") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(traitid), typeid, skillid, bonus, bonustext, unitid).shaped.<>({ r =>
        import r._; _1.map(_ => InvtraitsRow.tupled((_1.get, _2, _3, _4, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val bonustext: Rep[Option[String]] =
      column[Option[String]]("bonusText", O.Length(2147483647, varying = true), O.Default(None))
  ...
  implicit def GetResultInvtypematerialsRow(implicit e0: GR[Int]): GR[InvtypematerialsRow] = GR { prs =>
    import prs._
  ...
  class Invtypematerials(_tableTag: Tag) extends Table[InvtypematerialsRow](_tableTag, "invTypeMaterials") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(typeid), Rep.Some(materialtypeid), Rep.Some(quantity)).shaped.<>({ r =>
        import r._; _1.map(_ => InvtypematerialsRow.tupled((_1.get, _2.get, _3.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultInvtypereactionsRow(implicit e0: GR[Int],
                                            e1: GR[Boolean],
                                            e2: GR[Option[Short]]): GR[InvtypereactionsRow] = GR { prs =>
    import prs._
  ...
  class Invtypereactions(_tableTag: Tag) extends Table[InvtypereactionsRow](_tableTag, "invTypeReactions") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(reactiontypeid), Rep.Some(input), Rep.Some(typeid), quantity).shaped.<>({ r =>
        import r._; _1.map(_ => InvtypereactionsRow.tupled((_1.get, _2.get, _3.get, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class InvtypesRow(typeid: Int,
                         groupid: Option[Int] = None,
                         ...
                         portionsize: Option[Int] = None,
                         raceid: Option[Short] = None,
                         baseprice: Option[scala.math.BigDecimal] = None,
                         published: Option[Boolean] = None,
                         marketgroupid: Option[Long] = None,
                         iconid: Option[Long] = None,
                         soundid: Option[Long] = None)

  /** GetResult implicit for fetching InvtypesRow objects using plain SQL queries */
  implicit def GetResultInvtypesRow(implicit e0: GR[Int],
                                    e1: GR[Option[Int]],
                                    e2: GR[Option[String]],
                                    e3: GR[Option[Double]],
                                    e4: GR[Option[Short]],
                                    ...
                                    e6: GR[Option[Boolean]],
                                    e7: GR[Option[Long]]): GR[InvtypesRow] = GR { prs =>
    import prs._
    InvtypesRow.tupled(
      (<<[Int],
       <<?[Int],
  ...
  class Invtypes(_tableTag: Tag) extends Table[InvtypesRow](_tableTag, "invTypes") {
    def * =
      (typeid,
       ...
       marketgroupid,
       iconid,
       soundid) <> (InvtypesRow.tupled, InvtypesRow.unapply)
    ...
    def ? =
      (Rep.Some(typeid),
       ...
       iconid,
       soundid).shaped.<>({ r =>
        import r._; _1.map(_ => InvtypesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val typename: Rep[Option[String]] =
      column[Option[String]]("typeName", O.Length(100, varying = true), O.Default(None))
    ...
    val baseprice: Rep[Option[scala.math.BigDecimal]] =
      column[Option[scala.math.BigDecimal]]("basePrice", O.Default(None))
  ...
  implicit def GetResultInvuniquenamesRow(implicit e0: GR[Int],
                                          e1: GR[String],
                                          e2: GR[Option[Int]]): GR[InvuniquenamesRow] = GR { prs =>
    import prs._
  ...
  class Invuniquenames(_tableTag: Tag) extends Table[InvuniquenamesRow](_tableTag, "invUniqueNames") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(itemid), Rep.Some(itemname), groupid).shaped.<>({ r =>
        import r._; _1.map(_ => InvuniquenamesRow.tupled((_1.get, _2.get, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class MapcelestialstatisticsRow(celestialid: Int,
                                       temperature: Option[Double] = None,
                                       spectralclass: Option[String] = None,
                                       luminosity: Option[Double] = None,
                                       age: Option[Double] = None,
                                       life: Option[Double] = None,
                                       orbitradius: Option[Double] = None,
                                       eccentricity: Option[Double] = None,
                                       massdust: Option[Double] = None,
                                       massgas: Option[Double] = None,
                                       fragmented: Option[Int] = None,
                                       density: Option[Double] = None,
                                       surfacegravity: Option[Double] = None,
                                       escapevelocity: Option[Double] = None,
                                       orbitperiod: Option[Double] = None,
                                       rotationrate: Option[Double] = None,
                                       locked: Option[Int] = None,
                                       pressure: Option[Long] = None,
  ...
  implicit def GetResultMapcelestialstatisticsRow(implicit e0: GR[Int],
                                                  e1: GR[Option[Double]],
                                                  e2: GR[Option[String]],
                                                  e3: GR[Option[Int]],
                                                  e4: GR[Option[Long]]): GR[MapcelestialstatisticsRow] = GR { prs =>
    import prs._
    MapcelestialstatisticsRow.tupled(
      (<<[Int],
       <<?[Double],
       <<?[String],
       <<?[Double],
  ...
  class Mapcelestialstatistics(_tableTag: Tag)
      extends Table[MapcelestialstatisticsRow](_tableTag, "mapCelestialStatistics") {
    def * =
      (celestialid,
       temperature,
       spectralclass,
       ...
       pressure,
       radius,
       mass) <> (MapcelestialstatisticsRow.tupled, MapcelestialstatisticsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(celestialid),
       temperature,
       spectralclass,
       luminosity,
       age,
       ...
       mass).shaped.<>({ r =>
        ...
        _1.map(
          _ =>
            MapcelestialstatisticsRow.tupled(
              (_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val spectralclass: Rep[Option[String]] =
      column[Option[String]]("spectralClass", O.Length(10, varying = true), O.Default(None))
  ...
  case class MapconstellationjumpsRow(fromregionid: Option[Long] = None,
                                      fromconstellationid: Long,
                                      toconstellationid: Long,
                                      toregionid: Option[Long] = None)

  /** GetResult implicit for fetching MapconstellationjumpsRow objects using plain SQL queries */
  implicit def GetResultMapconstellationjumpsRow(implicit e0: GR[Option[Long]],
                                                 e1: GR[Long]): GR[MapconstellationjumpsRow] = GR { prs =>
    import prs._
  ...
  class Mapconstellationjumps(_tableTag: Tag)
      extends Table[MapconstellationjumpsRow](_tableTag, "mapConstellationJumps") {
    def * =
      (fromregionid, fromconstellationid, toconstellationid, toregionid) <> (MapconstellationjumpsRow.tupled, MapconstellationjumpsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (fromregionid, Rep.Some(fromconstellationid), Rep.Some(toconstellationid), toregionid).shaped.<>({ r =>
        import r._; _2.map(_ => MapconstellationjumpsRow.tupled((_1, _2.get, _3.get, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class MapconstellationsRow(regionid: Option[Int] = None,
                                  constellationid: Int,
                                  constellationname: Option[String] = None,
  ...
  implicit def GetResultMapconstellationsRow(implicit e0: GR[Option[Int]],
                                             e1: GR[Int],
                                             e2: GR[Option[String]],
                                             e3: GR[Option[Double]]): GR[MapconstellationsRow] = GR { prs =>
    import prs._
    MapconstellationsRow.tupled(
      (<<?[Int],
       <<[Int],
       <<?[String],
       <<?[Double],
  ...
  class Mapconstellations(_tableTag: Tag) extends Table[MapconstellationsRow](_tableTag, "mapConstellations") {
    def * =
      (regionid, constellationid, constellationname, x, y, z, xmin, xmax, ymin, ymax, zmin, zmax, factionid, radius) <> (MapconstellationsRow.tupled, MapconstellationsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (regionid,
       Rep.Some(constellationid),
       constellationname,
       x,
       y,
       z,
       ...
       radius).shaped.<>({ r =>
        import r._;
        _2.map(_ => MapconstellationsRow.tupled((_1, _2.get, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val constellationname: Rep[Option[String]] =
      column[Option[String]]("constellationName", O.Length(100, varying = true), O.Default(None))
  ...
  case class MapdenormalizeRow(itemid: Int,
                               typeid: Option[Int] = None,
                               groupid: Option[Int] = None,
                               solarsystemid: Option[Int] = None,
                               constellationid: Option[Int] = None,
                               regionid: Option[Int] = None,
                               orbitid: Option[Int] = None,
                               x: Option[Double] = None,
                               y: Option[Double] = None,
                               z: Option[Double] = None,
                               radius: Option[Double] = None,
                               itemname: Option[String] = None,
                               security: Option[Double] = None,
                               celestialindex: Option[Int] = None,
                               orbitindex: Option[Int] = None)

  /** GetResult implicit for fetching MapdenormalizeRow objects using plain SQL queries */
  implicit def GetResultMapdenormalizeRow(implicit e0: GR[Int],
                                          e1: GR[Option[Int]],
                                          e2: GR[Option[Double]],
                                          e3: GR[Option[String]]): GR[MapdenormalizeRow] = GR { prs =>
    import prs._
    MapdenormalizeRow.tupled(
      (<<[Int],
       <<?[Int],
       <<?[Int],
       <<?[Int],
  ...
  class Mapdenormalize(_tableTag: Tag) extends Table[MapdenormalizeRow](_tableTag, "mapDenormalize") {
    def * =
      (itemid,
       ...
       security,
       celestialindex,
       orbitindex) <> (MapdenormalizeRow.tupled, MapdenormalizeRow.unapply)
    ...
    def ? =
      (Rep.Some(itemid),
       ...
       orbitindex).shaped.<>({ r =>
        import r._;
        _1.map(_ => MapdenormalizeRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val itemname: Rep[Option[String]] =
      column[Option[String]]("itemName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultMapjumpsRow(implicit e0: GR[Long], e1: GR[Option[Long]]): GR[MapjumpsRow] = GR { prs =>
    import prs._
  ...
  class Mapjumps(_tableTag: Tag) extends Table[MapjumpsRow](_tableTag, "mapJumps") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(stargateid), destinationid).shaped.<>({ r =>
        import r._; _1.map(_ => MapjumpsRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Maplandmarks
    ...
    *  @param z Database column z SqlType(DOUBLE), Default(None)
    *  @param iconid Database column iconID SqlType(BIGINT), Default(None) */
  case class MaplandmarksRow(landmarkid: Long,
                             landmarkname: Option[String] = None,
                             description: Option[String] = None,
  ...
  implicit def GetResultMaplandmarksRow(implicit e0: GR[Long],
                                        e1: GR[Option[String]],
                                        e2: GR[Option[Long]],
                                        e3: GR[Option[Double]]): GR[MaplandmarksRow] = GR { prs =>
    import prs._
    MaplandmarksRow.tupled(
      (<<[Long], <<?[String], <<?[String], <<?[Long], <<?[Double], <<?[Double], <<?[Double], <<?[Long]))
  }
  ...
  class Maplandmarks(_tableTag: Tag) extends Table[MaplandmarksRow](_tableTag, "mapLandmarks") {
    def * =
      (landmarkid, landmarkname, description, locationid, x, y, z, iconid) <> (MaplandmarksRow.tupled, MaplandmarksRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(landmarkid), landmarkname, description, locationid, x, y, z, iconid).shaped.<>({ r =>
        import r._; _1.map(_ => MaplandmarksRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val landmarkname: Rep[Option[String]] =
      column[Option[String]]("landmarkName", O.Length(100, varying = true), O.Default(None))
  ...
  implicit def GetResultMaplocationscenesRow(implicit e0: GR[Int], e1: GR[Option[Int]]): GR[MaplocationscenesRow] =
    GR { prs =>
      import prs._
  ...
  class Maplocationscenes(_tableTag: Tag) extends Table[MaplocationscenesRow](_tableTag, "mapLocationScenes") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(locationid), graphicid).shaped.<>({ r =>
        import r._; _1.map(_ => MaplocationscenesRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultMaplocationwormholeclassesRow(implicit e0: GR[Int],
                                                      e1: GR[Option[Int]]): GR[MaplocationwormholeclassesRow] = GR {
    prs =>
      import prs._
  ...
  class Maplocationwormholeclasses(_tableTag: Tag)
      extends Table[MaplocationwormholeclassesRow](_tableTag, "mapLocationWormholeClasses") {
    def * =
      (locationid, wormholeclassid) <> (MaplocationwormholeclassesRow.tupled, MaplocationwormholeclassesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(locationid), wormholeclassid).shaped.<>({ r =>
        import r._; _1.map(_ => MaplocationwormholeclassesRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultMapregionjumpsRow(implicit e0: GR[Long]): GR[MapregionjumpsRow] = GR { prs =>
    import prs._
  ...
  class Mapregionjumps(_tableTag: Tag) extends Table[MapregionjumpsRow](_tableTag, "mapRegionJumps") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(fromregionid), Rep.Some(toregionid)).shaped.<>({ r =>
        import r._; _1.map(_ => MapregionjumpsRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Mapregions
    ...
    *  @param factionid Database column factionID SqlType(INT), Default(None)
    *  @param radius Database column radius SqlType(DOUBLE), Default(None) */
  case class MapregionsRow(regionid: Int,
  ...
  implicit def GetResultMapregionsRow(implicit e0: GR[Int],
                                      e1: GR[Option[String]],
                                      e2: GR[Option[Double]],
                                      e3: GR[Option[Int]]): GR[MapregionsRow] = GR { prs =>
    import prs._
    MapregionsRow.tupled(
      (<<[Int],
       <<?[String],
       <<?[Double],
       <<?[Double],
  ...
  class Mapregions(_tableTag: Tag) extends Table[MapregionsRow](_tableTag, "mapRegions") {
    def * =
      (regionid, regionname, x, y, z, xmin, xmax, ymin, ymax, zmin, zmax, factionid, radius) <> (MapregionsRow.tupled, MapregionsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(regionid), regionname, x, y, z, xmin, xmax, ymin, ymax, zmin, zmax, factionid, radius).shaped.<>({ r =>
        import r._; _1.map(_ => MapregionsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val regionname: Rep[Option[String]] =
      column[Option[String]]("regionName", O.Length(100, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Mapsolarsystemjumps
    ...
    *  @param toregionid Database column toRegionID SqlType(BIGINT), Default(None) */
  case class MapsolarsystemjumpsRow(fromregionid: Option[Long] = None,
                                    fromconstellationid: Option[Long] = None,
                                    fromsolarsystemid: Long,
                                    tosolarsystemid: Long,
                                    toconstellationid: Option[Long] = None,
                                    toregionid: Option[Long] = None)

  /** GetResult implicit for fetching MapsolarsystemjumpsRow objects using plain SQL queries */
  implicit def GetResultMapsolarsystemjumpsRow(implicit e0: GR[Option[Long]],
                                               e1: GR[Long]): GR[MapsolarsystemjumpsRow] = GR { prs =>
    import prs._
  ...
  class Mapsolarsystemjumps(_tableTag: Tag) extends Table[MapsolarsystemjumpsRow](_tableTag, "mapSolarSystemJumps") {
    def * =
      (fromregionid, fromconstellationid, fromsolarsystemid, tosolarsystemid, toconstellationid, toregionid) <> (MapsolarsystemjumpsRow.tupled, MapsolarsystemjumpsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (fromregionid,
       fromconstellationid,
       Rep.Some(fromsolarsystemid),
       Rep.Some(tosolarsystemid),
       toconstellationid,
       toregionid).shaped.<>({ r =>
        import r._; _3.map(_ => MapsolarsystemjumpsRow.tupled((_1, _2, _3.get, _4.get, _5, _6)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
                              ...
                              HCons[Option[Double],
                                    HCons[Option[Double],
                                          HCons[
                                            ...
                                            HCons[Option[Double],
                                                  HCons[Option[Double],
                                                        HCons[Option[Double],HCons[Option[Double],HCons[Option[Double],HCons[Option[Long],HCons[Option[Long],HCons[Option[Long],HCons[Option[Long],HCons[Option[Long],HCons[Option[Long],HCons[Option[Long],HCons[Option[Double],HCons[Option[Int],HCons[Option[Double],HCons[Option[Int],HCons[Option[String],HNil]]]]]]]]]]]]]]]]]]]]]]]]]]
  /** Constructor for MapsolarsystemsRow providing default values if available in the database schema. */
  def MapsolarsystemsRow(regionid: Option[Int] = None,
                         constellationid: Option[Int] = None,
                         solarsystemid: Int,
                         solarsystemname: Option[String] = None,
                         x: Option[Double] = None,
                         y: Option[Double] = None,
                         z: Option[Double] = None,
                         xmin: Option[Double] = None,
                         ...
                         zmax: Option[Double] = None,
                         luminosity: Option[Double] = None,
                         border: Option[Long] = None,
                         fringe: Option[Long] = None,
                         corridor: Option[Long] = None,
                         hub: Option[Long] = None,
                         international: Option[Long] = None,
                         regional: Option[Long] = None,
                         constellation: Option[Long] = None,
                         security: Option[Double] = None,
                         factionid: Option[Int] = None,
                         radius: Option[Double] = None,
                         suntypeid: Option[Int] = None,
                         securityclass: Option[String] = None): MapsolarsystemsRow = {
  ...
  implicit def GetResultMapsolarsystemsRow(implicit e0: GR[Option[Int]],
                                           e1: GR[Int],
                                           e2: GR[Option[String]],
                                           e3: GR[Option[Double]],
                                           e4: GR[Option[Long]]): GR[MapsolarsystemsRow] = GR { prs =>
    import prs._
    <<?[Int] :: <<?[Int] :: <<[Int] :: <<?[String] :: <<?[Double] :: <<?[Double] :: <<?[Double] :: <<?[Double] :: <<?[
      Double] :: <<?[Double] :: <<?[Double] :: <<?[Double] :: <<?[Double] :: <<?[Double] :: <<?[Long] :: <<?[Long] :: <<?[
      Long] :: <<?[Long] :: <<?[Long] :: <<?[Long] :: <<?[Long] :: <<?[Double] :: <<?[Int] :: <<?[Double] :: <<?[Int] :: <<?[
      String] :: HNil
  }
  ...
  class Mapsolarsystems(_tableTag: Tag) extends Table[MapsolarsystemsRow](_tableTag, "mapSolarSystems") {
    ...
    val solarsystemname: Rep[Option[String]] =
      column[Option[String]]("solarSystemName", O.Length(100, varying = true), O.Default(None))
    ...
    val securityclass: Rep[Option[String]] =
      column[Option[String]]("securityClass", O.Length(2, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Mapuniverse
    ...
    *  @param zmax Database column zMax SqlType(DOUBLE), Default(None)
    *  @param radius Database column radius SqlType(DOUBLE), Default(None) */
  case class MapuniverseRow(universeid: Int,
                            universename: Option[String] = None,
                            x: Option[Double] = None,
                            y: Option[Double] = None,
                            z: Option[Double] = None,
                            xmin: Option[Double] = None,
  ...
  implicit def GetResultMapuniverseRow(implicit e0: GR[Int],
                                       e1: GR[Option[String]],
                                       e2: GR[Option[Double]]): GR[MapuniverseRow] = GR { prs =>
    import prs._
    MapuniverseRow.tupled(
      (<<[Int],
       <<?[String],
       <<?[Double],
       <<?[Double],
  ...
  class Mapuniverse(_tableTag: Tag) extends Table[MapuniverseRow](_tableTag, "mapUniverse") {
    def * =
      (universeid, universename, x, y, z, xmin, xmax, ymin, ymax, zmin, zmax, radius) <> (MapuniverseRow.tupled, MapuniverseRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(universeid), universename, x, y, z, xmin, xmax, ymin, ymax, zmin, zmax, radius).shaped.<>({ r =>
        import r._; _1.map(_ => MapuniverseRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val universename: Rep[Option[String]] =
      column[Option[String]]("universeName", O.Length(100, varying = true), O.Default(None))
  ...
  case class PlanetschematicsRow(schematicid: Short,
                                 schematicname: Option[String] = None,
                                 cycletime: Option[Int] = None)

  /** GetResult implicit for fetching PlanetschematicsRow objects using plain SQL queries */
  implicit def GetResultPlanetschematicsRow(implicit e0: GR[Short],
                                            e1: GR[Option[String]],
                                            e2: GR[Option[Int]]): GR[PlanetschematicsRow] = GR { prs =>
    import prs._
  ...
  class Planetschematics(_tableTag: Tag) extends Table[PlanetschematicsRow](_tableTag, "planetSchematics") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(schematicid), schematicname, cycletime).shaped.<>({ r =>
        import r._; _1.map(_ => PlanetschematicsRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val schematicname: Rep[Option[String]] =
      column[Option[String]]("schematicName", O.Length(255, varying = true), O.Default(None))
  ...
  implicit def GetResultPlanetschematicspinmapRow(implicit e0: GR[Short], e1: GR[Int]): GR[PlanetschematicspinmapRow] =
    GR { prs =>
      import prs._
  ...
  class Planetschematicspinmap(_tableTag: Tag)
      extends Table[PlanetschematicspinmapRow](_tableTag, "planetSchematicsPinMap") {
    def * = (schematicid, pintypeid) <> (PlanetschematicspinmapRow.tupled, PlanetschematicspinmapRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(schematicid), Rep.Some(pintypeid)).shaped.<>({ r =>
        import r._; _1.map(_ => PlanetschematicspinmapRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class PlanetschematicstypemapRow(schematicid: Short,
                                        typeid: Int,
                                        quantity: Option[Short] = None,
                                        isinput: Option[Boolean] = None)

  /** GetResult implicit for fetching PlanetschematicstypemapRow objects using plain SQL queries */
  implicit def GetResultPlanetschematicstypemapRow(implicit e0: GR[Short],
                                                   e1: GR[Int],
                                                   e2: GR[Option[Short]],
                                                   e3: GR[Option[Boolean]]): GR[PlanetschematicstypemapRow] = GR {
    prs =>
      import prs._
  ...
  class Planetschematicstypemap(_tableTag: Tag)
      extends Table[PlanetschematicstypemapRow](_tableTag, "planetSchematicsTypeMap") {
    def * =
      (schematicid, typeid, quantity, isinput) <> (PlanetschematicstypemapRow.tupled, PlanetschematicstypemapRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(schematicid), Rep.Some(typeid), quantity, isinput).shaped.<>({ r =>
        import r._; _1.map(_ => PlanetschematicstypemapRow.tupled((_1.get, _2.get, _3, _4)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Ramactivities
    ...
    *  @param description Database column description SqlType(VARCHAR), Length(1000,true), Default(None)
    *  @param published Database column published SqlType(BIT), Default(None) */
  case class RamactivitiesRow(activityid: Byte,
                              activityname: Option[String] = None,
                              iconno: Option[String] = None,
                              description: Option[String] = None,
                              published: Option[Boolean] = None)

  /** GetResult implicit for fetching RamactivitiesRow objects using plain SQL queries */
  implicit def GetResultRamactivitiesRow(implicit e0: GR[Byte],
                                         e1: GR[Option[String]],
                                         e2: GR[Option[Boolean]]): GR[RamactivitiesRow] = GR { prs =>
    import prs._
  ...
  class Ramactivities(_tableTag: Tag) extends Table[RamactivitiesRow](_tableTag, "ramActivities") {
    def * =
      (activityid, activityname, iconno, description, published) <> (RamactivitiesRow.tupled, RamactivitiesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(activityid), activityname, iconno, description, published).shaped.<>({ r =>
        import r._; _1.map(_ => RamactivitiesRow.tupled((_1.get, _2, _3, _4, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Ramassemblylinestations
    ...
    *  @param solarsystemid Database column solarSystemID SqlType(INT), Default(None)
    *  @param regionid Database column regionID SqlType(INT), Default(None) */
  case class RamassemblylinestationsRow(stationid: Int,
                                        assemblylinetypeid: Byte,
                                        quantity: Option[Byte] = None,
                                        stationtypeid: Option[Int] = None,
                                        ownerid: Option[Int] = None,
                                        solarsystemid: Option[Int] = None,
                                        regionid: Option[Int] = None)

  /** GetResult implicit for fetching RamassemblylinestationsRow objects using plain SQL queries */
  implicit def GetResultRamassemblylinestationsRow(implicit e0: GR[Int],
                                                   e1: GR[Byte],
                                                   e2: GR[Option[Byte]],
                                                   e3: GR[Option[Int]]): GR[RamassemblylinestationsRow] = GR { prs =>
    import prs._
  ...
  class Ramassemblylinestations(_tableTag: Tag)
      extends Table[RamassemblylinestationsRow](_tableTag, "ramAssemblyLineStations") {
    def * =
      (stationid, assemblylinetypeid, quantity, stationtypeid, ownerid, solarsystemid, regionid) <> (RamassemblylinestationsRow.tupled, RamassemblylinestationsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(stationid), Rep.Some(assemblylinetypeid), quantity, stationtypeid, ownerid, solarsystemid, regionid).shaped
        .<>({ r =>
          import r._; _1.map(_ => RamassemblylinestationsRow.tupled((_1.get, _2.get, _3, _4, _5, _6, _7)))
        }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class RamassemblylinetypedetailpercategoryRow(assemblylinetypeid: Byte,
                                                     categoryid: Int,
                                                     timemultiplier: Option[Double] = None,
                                                     materialmultiplier: Option[Double] = None,
                                                     costmultiplier: Option[Double] = None)

  /** GetResult implicit for fetching RamassemblylinetypedetailpercategoryRow objects using plain SQL queries */
  implicit def GetResultRamassemblylinetypedetailpercategoryRow(
      implicit e0: GR[Byte],
      e1: GR[Int],
      e2: GR[Option[Double]]): GR[RamassemblylinetypedetailpercategoryRow] = GR { prs =>
    import prs._
  ...
  class Ramassemblylinetypedetailpercategory(_tableTag: Tag)
      extends Table[RamassemblylinetypedetailpercategoryRow](_tableTag, "ramAssemblyLineTypeDetailPerCategory") {
    def * =
      (assemblylinetypeid, categoryid, timemultiplier, materialmultiplier, costmultiplier) <> (RamassemblylinetypedetailpercategoryRow.tupled, RamassemblylinetypedetailpercategoryRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(assemblylinetypeid), Rep.Some(categoryid), timemultiplier, materialmultiplier, costmultiplier).shaped
        .<>({ r =>
          import r._; _1.map(_ => RamassemblylinetypedetailpercategoryRow.tupled((_1.get, _2.get, _3, _4, _5)))
        }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Entity class storing rows of table Ramassemblylinetypedetailpergroup
    ...
    *  @param materialmultiplier Database column materialMultiplier SqlType(DOUBLE), Default(None)
    *  @param costmultiplier Database column costMultiplier SqlType(DOUBLE), Default(None) */
  case class RamassemblylinetypedetailpergroupRow(assemblylinetypeid: Byte,
                                                  groupid: Int,
                                                  timemultiplier: Option[Double] = None,
                                                  materialmultiplier: Option[Double] = None,
                                                  costmultiplier: Option[Double] = None)
  ...
  implicit def GetResultRamassemblylinetypedetailpergroupRow(
      implicit e0: GR[Byte],
      e1: GR[Int],
      e2: GR[Option[Double]]): GR[RamassemblylinetypedetailpergroupRow] = GR { prs =>
    import prs._
  ...
  class Ramassemblylinetypedetailpergroup(_tableTag: Tag)
      extends Table[RamassemblylinetypedetailpergroupRow](_tableTag, "ramAssemblyLineTypeDetailPerGroup") {
    def * =
      (assemblylinetypeid, groupid, timemultiplier, materialmultiplier, costmultiplier) <> (RamassemblylinetypedetailpergroupRow.tupled, RamassemblylinetypedetailpergroupRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(assemblylinetypeid), Rep.Some(groupid), timemultiplier, materialmultiplier, costmultiplier).shaped.<>({
        r =>
          import r._; _1.map(_ => RamassemblylinetypedetailpergroupRow.tupled((_1.get, _2.get, _3, _4, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class RamassemblylinetypesRow(assemblylinetypeid: Byte,
                                     assemblylinetypename: Option[String] = None,
                                     description: Option[String] = None,
                                     basetimemultiplier: Option[Double] = None,
                                     basematerialmultiplier: Option[Double] = None,
                                     basecostmultiplier: Option[Double] = None,
                                     volume: Option[Double] = None,
                                     activityid: Option[Byte] = None,
                                     mincostperhour: Option[Double] = None)

  /** GetResult implicit for fetching RamassemblylinetypesRow objects using plain SQL queries */
  implicit def GetResultRamassemblylinetypesRow(implicit e0: GR[Byte],
                                                e1: GR[Option[String]],
                                                e2: GR[Option[Double]],
                                                e3: GR[Option[Byte]]): GR[RamassemblylinetypesRow] = GR { prs =>
    import prs._
    RamassemblylinetypesRow.tupled(
      (<<[Byte], <<?[String], <<?[String], <<?[Double], <<?[Double], <<?[Double], <<?[Double], <<?[Byte], <<?[Double]))
  }

  /** Table description of table ramAssemblyLineTypes. Objects of this class serve as prototypes for rows in queries. */
  class Ramassemblylinetypes(_tableTag: Tag)
      extends Table[RamassemblylinetypesRow](_tableTag, "ramAssemblyLineTypes") {
    def * =
      (assemblylinetypeid,
       ...
       volume,
       activityid,
       mincostperhour) <> (RamassemblylinetypesRow.tupled, RamassemblylinetypesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(assemblylinetypeid),
       assemblylinetypename,
       description,
       basetimemultiplier,
       basematerialmultiplier,
       ...
       volume,
       activityid,
       mincostperhour).shaped.<>({ r =>
        import r._; _1.map(_ => RamassemblylinetypesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val assemblylinetypename: Rep[Option[String]] =
      column[Option[String]]("assemblyLineTypeName", O.Length(100, varying = true), O.Default(None))
  ...
  /** Entity class storing rows of table Raminstallationtypecontents
    ...
    *  @param assemblylinetypeid Database column assemblyLineTypeID SqlType(TINYINT UNSIGNED)
    *  @param quantity Database column quantity SqlType(TINYINT UNSIGNED), Default(None) */
  case class RaminstallationtypecontentsRow(installationtypeid: Int,
                                            assemblylinetypeid: Byte,
                                            quantity: Option[Byte] = None)

  /** GetResult implicit for fetching RaminstallationtypecontentsRow objects using plain SQL queries */
  implicit def GetResultRaminstallationtypecontentsRow(implicit e0: GR[Int],
                                                       e1: GR[Byte],
                                                       e2: GR[Option[Byte]]): GR[RaminstallationtypecontentsRow] = GR {
    prs =>
      import prs._
  ...
  class Raminstallationtypecontents(_tableTag: Tag)
      extends Table[RaminstallationtypecontentsRow](_tableTag, "ramInstallationTypeContents") {
    def * =
      (installationtypeid, assemblylinetypeid, quantity) <> (RaminstallationtypecontentsRow.tupled, RaminstallationtypecontentsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(installationtypeid), Rep.Some(assemblylinetypeid), quantity).shaped.<>({ r =>
        import r._; _1.map(_ => RaminstallationtypecontentsRow.tupled((_1.get, _2.get, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultSkinlicenseRow(implicit e0: GR[Int], e1: GR[Option[Int]]): GR[SkinlicenseRow] = GR { prs =>
    import prs._
  ...
  class Skinlicense(_tableTag: Tag) extends Table[SkinlicenseRow](_tableTag, "skinLicense") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(licensetypeid), duration, skinid).shaped.<>({ r =>
        import r._; _1.map(_ => SkinlicenseRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class SkinmaterialsRow(skinmaterialid: Int,
                              displaynameid: Option[Int] = None,
                              materialsetid: Option[Int] = None)

  /** GetResult implicit for fetching SkinmaterialsRow objects using plain SQL queries */
  implicit def GetResultSkinmaterialsRow(implicit e0: GR[Int], e1: GR[Option[Int]]): GR[SkinmaterialsRow] = GR { prs =>
    import prs._
  ...
  class Skinmaterials(_tableTag: Tag) extends Table[SkinmaterialsRow](_tableTag, "skinMaterials") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(skinmaterialid), displaynameid, materialsetid).shaped.<>({ r =>
        import r._; _1.map(_ => SkinmaterialsRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultSkinsRow(implicit e0: GR[Int], e1: GR[Option[String]], e2: GR[Option[Int]]): GR[SkinsRow] =
    GR { prs =>
      import prs._
  ...
  class Skins(_tableTag: Tag) extends Table[SkinsRow](_tableTag, "skins") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(skinid), internalname, skinmaterialid).shaped.<>({ r =>
        import r._; _1.map(_ => SkinsRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val internalname: Rep[Option[String]] =
      column[Option[String]]("internalName", O.Length(70, varying = true), O.Default(None))
  ...
  implicit def GetResultSkinshipRow(implicit e0: GR[Option[Int]]): GR[SkinshipRow] = GR { prs =>
    import prs._
  ...
  case class StaoperationsRow(activityid: Option[Byte] = None,
                              operationid: Byte,
                              ...
                              hub: Option[Byte] = None,
                              border: Option[Byte] = None,
                              ratio: Option[Byte] = None,
                              caldaristationtypeid: Option[Int] = None,
                              minmatarstationtypeid: Option[Int] = None,
                              amarrstationtypeid: Option[Int] = None,
                              gallentestationtypeid: Option[Int] = None,
                              jovestationtypeid: Option[Int] = None)

  /** GetResult implicit for fetching StaoperationsRow objects using plain SQL queries */
  implicit def GetResultStaoperationsRow(implicit e0: GR[Option[Byte]],
                                         e1: GR[Byte],
                                         e2: GR[Option[String]],
                                         e3: GR[Option[Int]]): GR[StaoperationsRow] = GR { prs =>
    import prs._
    StaoperationsRow.tupled(
      (<<?[Byte],
       <<[Byte],
       <<?[String],
       <<?[String],
  ...
  class Staoperations(_tableTag: Tag) extends Table[StaoperationsRow](_tableTag, "staOperations") {
    def * =
      (activityid,
       ...
       jovestationtypeid) <> (StaoperationsRow.tupled, StaoperationsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (activityid,
       Rep.Some(operationid),
       operationname,
       description,
       fringe,
       corridor,
       ...
       amarrstationtypeid,
       gallentestationtypeid,
       jovestationtypeid).shaped.<>({ r =>
        import r._;
        _2.map(_ => StaoperationsRow.tupled((_1, _2.get, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val operationname: Rep[Option[String]] =
      column[Option[String]]("operationName", O.Length(100, varying = true), O.Default(None))
  ...
  class Staoperationservices(_tableTag: Tag)
      extends Table[StaoperationservicesRow](_tableTag, "staOperationServices") {
    def * = (operationid, serviceid) <> (StaoperationservicesRow.tupled, StaoperationservicesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(operationid), Rep.Some(serviceid)).shaped.<>({ r =>
        import r._; _1.map(_ => StaoperationservicesRow.tupled((_1.get, _2.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  implicit def GetResultStaservicesRow(implicit e0: GR[Int], e1: GR[Option[String]]): GR[StaservicesRow] = GR { prs =>
    import prs._
  ...
  class Staservices(_tableTag: Tag) extends Table[StaservicesRow](_tableTag, "staServices") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(serviceid), servicename, description).shaped.<>({ r =>
        import r._; _1.map(_ => StaservicesRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val servicename: Rep[Option[String]] =
      column[Option[String]]("serviceName", O.Length(100, varying = true), O.Default(None))
  ...
  case class StastationsRow(stationid: Int,
                            security: Option[Short] = None,
                            dockingcostpervolume: Option[Double] = None,
                            maxshipvolumedockable: Option[Double] = None,
                            officerentalcost: Option[Int] = None,
                            operationid: Option[Byte] = None,
                            stationtypeid: Option[Int] = None,
                            corporationid: Option[Int] = None,
                            solarsystemid: Option[Int] = None,
                            constellationid: Option[Int] = None,
                            ...
                            y: Option[Double] = None,
                            z: Option[Double] = None,
                            reprocessingefficiency: Option[Double] = None,
                            reprocessingstationstake: Option[Double] = None,
                            reprocessinghangarflag: Option[Byte] = None)

  /** GetResult implicit for fetching StastationsRow objects using plain SQL queries */
  implicit def GetResultStastationsRow(implicit e0: GR[Int],
                                       e1: GR[Option[Short]],
                                       e2: GR[Option[Double]],
                                       e3: GR[Option[Int]],
                                       e4: GR[Option[Byte]],
                                       e5: GR[Option[String]]): GR[StastationsRow] = GR { prs =>
    import prs._
    StastationsRow.tupled(
      (<<[Int],
       <<?[Short],
       <<?[Double],
       <<?[Double],
  ...
  class Stastations(_tableTag: Tag) extends Table[StastationsRow](_tableTag, "staStations") {
    def * =
      (stationid,
       ...
       reprocessinghangarflag) <> (StastationsRow.tupled, StastationsRow.unapply)
    ...
    def ? =
      (Rep.Some(stationid),
       ...
       reprocessingefficiency,
       reprocessingstationstake,
       reprocessinghangarflag).shaped.<>({ r =>
        import r._;
        _1.map(_ =>
          StastationsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val stationname: Rep[Option[String]] =
      column[Option[String]]("stationName", O.Length(100, varying = true), O.Default(None))
    ...
    val reprocessingstationstake: Rep[Option[Double]] =
      column[Option[Double]]("reprocessingStationsTake", O.Default(None))
  ...
  case class StastationtypesRow(stationtypeid: Int,
                                dockentryx: Option[Double] = None,
                                dockentryy: Option[Double] = None,
                                dockentryz: Option[Double] = None,
                                dockorientationx: Option[Double] = None,
                                dockorientationy: Option[Double] = None,
                                dockorientationz: Option[Double] = None,
                                operationid: Option[Byte] = None,
                                officeslots: Option[Byte] = None,
                                reprocessingefficiency: Option[Double] = None,
                                conquerable: Option[Boolean] = None)

  /** GetResult implicit for fetching StastationtypesRow objects using plain SQL queries */
  implicit def GetResultStastationtypesRow(implicit e0: GR[Int],
                                           e1: GR[Option[Double]],
                                           e2: GR[Option[Byte]],
                                           e3: GR[Option[Boolean]]): GR[StastationtypesRow] = GR { prs =>
    import prs._
    StastationtypesRow.tupled(
      (<<[Int],
       <<?[Double],
       <<?[Double],
       <<?[Double],
  ...
  class Stastationtypes(_tableTag: Tag) extends Table[StastationtypesRow](_tableTag, "staStationTypes") {
    def * =
      (stationtypeid,
       ...
       officeslots,
       reprocessingefficiency,
       conquerable) <> (StastationtypesRow.tupled, StastationtypesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(stationtypeid),
       dockentryx,
       dockentryy,
       dockentryz,
       dockorientationx,
       ...
       officeslots,
       reprocessingefficiency,
       conquerable).shaped.<>({ r =>
        import r._; _1.map(_ => StastationtypesRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class TranslationtablesRow(sourcetable: String,
                                  destinationtable: Option[String] = None,
                                  translatedkey: String,
                                  tcgroupid: Option[Int] = None,
                                  tcid: Option[Int] = None)

  /** GetResult implicit for fetching TranslationtablesRow objects using plain SQL queries */
  implicit def GetResultTranslationtablesRow(implicit e0: GR[String],
                                             e1: GR[Option[String]],
                                             e2: GR[Option[Int]]): GR[TranslationtablesRow] = GR { prs =>
    import prs._
  ...
  class Translationtables(_tableTag: Tag) extends Table[TranslationtablesRow](_tableTag, "translationTables") {
    def * =
      (sourcetable, destinationtable, translatedkey, tcgroupid, tcid) <> (TranslationtablesRow.tupled, TranslationtablesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(sourcetable), destinationtable, Rep.Some(translatedkey), tcgroupid, tcid).shaped.<>({ r =>
        import r._; _1.map(_ => TranslationtablesRow.tupled((_1.get, _2, _3.get, _4, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val destinationtable: Rep[Option[String]] =
      column[Option[String]]("destinationTable", O.Length(200, varying = true), O.Default(None))
  ...
  case class TrntranslationcolumnsRow(tcgroupid: Option[Short] = None,
                                      tcid: Short,
                                      tablename: String,
                                      columnname: String,
  ...
  implicit def GetResultTrntranslationcolumnsRow(implicit e0: GR[Option[Short]],
                                                 e1: GR[Short],
                                                 e2: GR[String],
                                                 e3: GR[Option[String]]): GR[TrntranslationcolumnsRow] = GR { prs =>
    import prs._
  ...
  class Trntranslationcolumns(_tableTag: Tag)
      extends Table[TrntranslationcolumnsRow](_tableTag, "trnTranslationColumns") {
    def * =
      (tcgroupid, tcid, tablename, columnname, masterid) <> (TrntranslationcolumnsRow.tupled, TrntranslationcolumnsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (tcgroupid, Rep.Some(tcid), Rep.Some(tablename), Rep.Some(columnname), masterid).shaped.<>({ r =>
        import r._; _2.map(_ => TrntranslationcolumnsRow.tupled((_1, _2.get, _3.get, _4.get, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val masterid: Rep[Option[String]] =
      column[Option[String]]("masterID", O.Length(128, varying = true), O.Default(None))
  }
  ...
  case class TrntranslationlanguagesRow(numericlanguageid: Int,
  ...
  implicit def GetResultTrntranslationlanguagesRow(implicit e0: GR[Int],
                                                   e1: GR[Option[String]]): GR[TrntranslationlanguagesRow] = GR {
    prs =>
      import prs._
  ...
  class Trntranslationlanguages(_tableTag: Tag)
      extends Table[TrntranslationlanguagesRow](_tableTag, "trnTranslationLanguages") {
    def * =
      (numericlanguageid, languageid, languagename) <> (TrntranslationlanguagesRow.tupled, TrntranslationlanguagesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(numericlanguageid), languageid, languagename).shaped.<>({ r =>
        import r._; _1.map(_ => TrntranslationlanguagesRow.tupled((_1.get, _2, _3)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val languageid: Rep[Option[String]] =
      column[Option[String]]("languageID", O.Length(50, varying = true), O.Default(None))

    /** Database column languageName SqlType(VARCHAR), Length(200,true), Default(None) */
    val languagename: Rep[Option[String]] =
      column[Option[String]]("languageName", O.Length(200, varying = true), O.Default(None))
  }
  ...
  implicit def GetResultTrntranslationsRow(implicit e0: GR[Short],
                                           e1: GR[Int],
                                           e2: GR[String]): GR[TrntranslationsRow] = GR { prs =>
    import prs._
  ...
  class Trntranslations(_tableTag: Tag) extends Table[TrntranslationsRow](_tableTag, "trnTranslations") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(tcid), Rep.Some(keyid), Rep.Some(languageid), Rep.Some(text)).shaped.<>({ r =>
        import r._; _1.map(_ => TrntranslationsRow.tupled((_1.get, _2.get, _3.get, _4.get)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
  ...
  case class WarcombatzonesRow(combatzoneid: Int = -1,
                               combatzonename: Option[String] = None,
                               factionid: Option[Int] = None,
                               centersystemid: Option[Int] = None,
                               description: Option[String] = None)

  /** GetResult implicit for fetching WarcombatzonesRow objects using plain SQL queries */
  implicit def GetResultWarcombatzonesRow(implicit e0: GR[Int],
                                          e1: GR[Option[String]],
                                          e2: GR[Option[Int]]): GR[WarcombatzonesRow] = GR { prs =>
    import prs._
  ...
  class Warcombatzones(_tableTag: Tag) extends Table[WarcombatzonesRow](_tableTag, "warCombatZones") {
    def * =
      (combatzoneid, combatzonename, factionid, centersystemid, description) <> (WarcombatzonesRow.tupled, WarcombatzonesRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(combatzoneid), combatzonename, factionid, centersystemid, description).shaped.<>({ r =>
        import r._; _1.map(_ => WarcombatzonesRow.tupled((_1.get, _2, _3, _4, _5)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
    ...
    val combatzonename: Rep[Option[String]] =
      column[Option[String]]("combatZoneName", O.Length(100, varying = true), O.Default(None))
    ...
    val description: Rep[Option[String]] =
      column[Option[String]]("description", O.Length(500, varying = true), O.Default(None))
  }
  ...
  implicit def GetResultWarcombatzonesystemsRow(implicit e0: GR[Int],
                                                e1: GR[Option[Int]]): GR[WarcombatzonesystemsRow] = GR { prs =>
    import prs._
  ...
  class Warcombatzonesystems(_tableTag: Tag)
      extends Table[WarcombatzonesystemsRow](_tableTag, "warCombatZoneSystems") {
    def * = (solarsystemid, combatzoneid) <> (WarcombatzonesystemsRow.tupled, WarcombatzonesystemsRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? =
      (Rep.Some(solarsystemid), combatzoneid).shaped.<>({ r =>
        import r._; _1.map(_ => WarcombatzonesystemsRow.tupled((_1.get, _2)))
      }, (_: Any) => throw new Exception("Inserting into ? projection not supported."))
